@section('title', 'Cloud Computing Service | OrFactor')
...
@section('content')
    ...
    <div class="common-banner common-banner-iphone">
        <div class="bg-shade">
            <div class="common-banner-content center-text-align">
                <span>Minimized Risks. Increased Performance</span>
                <h1>Cloud Computing Services</h1>
                <p>Supporting Enterprise Agility Through Flexible, Scalable And Cost-Effective Cloud Services</p>
    ...
    <div class="bb-f-container">
        <h1 class="common-header-h"><b>Bitcoin App Development</b> Services</h1>
        <p>
