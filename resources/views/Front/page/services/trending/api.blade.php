@section('title', 'Api Integration Service | OrFactor')
    ...
    <div class="common-banner common-banner-iphone">
        <div class="bg-shade">
            <div class="common-banner-content center-text-align">
                <h1>API Integration Services Company</h1>
                <p>Seamless API integration services for greater operational efficiency</p>
