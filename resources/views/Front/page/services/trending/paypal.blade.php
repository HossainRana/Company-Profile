@section('title', 'PayPal Integration Service | OrFactor')
    ...
    <div class="common-banner common-banner-iphone">
        <div class="bg-shade">
            <div class="common-banner-content center-text-align">
                <h1>PayPal Integration Services</h1>
                <p>Reduce Cart Abandonment and Increase Conversion Rate with Faster Checkouts</p>
