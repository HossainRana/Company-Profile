@section('title', 'Sap UI Development | OrFactor')
    ...
    <div class="common-banner common-banner-iphone">
        <div class="bg-shade">
            <div class="common-banner-content center-text-align">
                <span>Develop Intuitive, Easy and Efficient Applications</span>
                <h1>SAP UI Development Services</h1>
                <p>Make the user experience ‘WOW’</p>
