@section('title', 'Brand Portfolio | OrFactor')
...
@section('content')
    ...
    <div class="portfolio-lik-tab">
        <ul class="portfolio-nav">
            ...
            <li class="portfolio-nav-item">
                <a class="portfolio-nav-link" href="{{URL::to('/portfolio-mobile')}}" >Mobile</a>
            </li>
            <li class="portfolio-nav-item ">
                <a class="portfolio-nav-link active"href="{{URL::to('/portfolio-brand')}}" >Brand</a>
            </li>
        </ul>
    </div>
